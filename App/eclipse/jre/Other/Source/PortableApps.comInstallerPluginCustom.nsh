...
!macro CustomCodePostInstall
	Rename "$INSTDIR\jre1.8.0_144\bin" "$INSTDIR\bin"
	Rename "$INSTDIR\jre1.8.0_144\lib" "$INSTDIR\lib"
	Rename "$INSTDIR\jre1.8.0_144\COPYRIGHT" "$INSTDIR\COPYRIGHT"
	Rename "$INSTDIR\jre1.8.0_144\LICENSE" "$INSTDIR\LICENSE"
	Rename "$INSTDIR\jre1.8.0_144\README.txt" "$INSTDIR\README.txt"
	Rename "$INSTDIR\jre1.8.0_144\release" "$INSTDIR\release"
	Rename "$INSTDIR\jre1.8.0_144\THIRDPARTYLICENSEREADME.txt" "$INSTDIR\THIRDPARTYLICENSEREADME.txt"
	Rename "$INSTDIR\jre1.8.0_144\THIRDPARTYLICENSEREADME-JAVAFX.txt" "$INSTDIR\THIRDPARTYLICENSEREADME-JAVAFX.txt"
	Rename "$INSTDIR\jre1.8.0_144\Welcome.html" "$INSTDIR\Welcome.html"
	RMDir "$INSTDIR\jre1.8.0_144"
